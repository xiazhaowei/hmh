...
angular.module(appName, ["kendo.directives"]).controller("app.admin.settings.userdistribution", ["$scope", "$state", function ($scope, $state) {
    $scope.title = $state.current.data.pageTitle;
    $scope.gridOptions = $.osharp.kendo.grid.Options({
        url: {
            read: "/admin/userdistribution/read",
            create: "/admin/userdistribution/create",
            update: "/admin/userdistribution/update",
            destroy: "/admin/userdistribution/delete"
        },
        model: {
            id: "Id",
            fields: {
