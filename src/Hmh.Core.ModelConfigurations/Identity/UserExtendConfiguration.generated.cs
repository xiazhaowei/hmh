...
// -----------------------------------------------------------------------
//  <copyright file="UserExtendConfiguration.generated.cs" company="OSharp开源团队">
...
namespace Hmh.Core.ModelConfigurations.Identity
{
    ...
    /// 实体类-数据表映射——用户扩展信息
    /// </summary> 
	public partial class UserExtendConfiguration : EntityConfigurationBase<UserExtend, int>
    { 
        /// <summary>
