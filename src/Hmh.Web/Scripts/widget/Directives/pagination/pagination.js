 ...
 * Version: 1.0.0 beta
 */
angular.module('hmh.paginaction', []).directive('hmhPagination', [function () {
    return {
        restrict: 'EA',
        template:
            '<div class="page-list">' +
            '   <ul class="pagination" ng-show="conf.totalItems > conf.itemsPerPage">' +
            ...
            '   </ul>' +
            '   <div class="page-total" ng-show="conf.totalItems > conf.itemsPerPage">' +
            ...
            '   </div>' +
            '   <div class="no-items" ng-show="conf.totalItems <= 0"><span class="fa fa-file-o"></span> 暂无数据</div>' +
            '</div>',
        replace: true,
        scope: {
            conf: '='
